...
def main():
    ...
    output_file = os.path.join(dir_comparisons, "2024_WEB_Changes.sql")
...
def get_my_line(fr3, target_line, current_line):
    ...
    while not current_line.startswith(target_line[:98]):
        ...
        # if current_line =="":
            # current_line = "INSERT INTO `verses` (`bookCode`, `chapter`, `verseNumber`, `verseText`) VALUES ('PSA', 119, 101, 'I understand more than the aged, because I have kept your precepts.');\n"
